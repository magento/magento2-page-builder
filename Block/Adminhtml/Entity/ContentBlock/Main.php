...
namespace Gene\BlueFoot\Block\Adminhtml\Entity\ContentBlock;
 ...
 * Class Main
 *
 * @package Magento\Catalog\Block\Adminhtml\Product\Attribute\Set\Toolbar
 *
...
class Main extends \Magento\Backend\Block\Template
{
     ...
     * @var string
     */
    protected $_template = 'entity/attribute/contentblock/main.phtml';
    ...
    protected function _prepareLayout()
    {
        ...
        $this->addChild('group_tree', 'Gene\BlueFoot\Block\Adminhtml\Entity\ContentBlock\Main\Tree\Group');

        $this->addChild('edit_set_form', 'Gene\BlueFoot\Block\Adminhtml\Entity\ContentBlock\Main\Formset');
        ...
        $this->addChild(
            'rename_button',
            'Magento\Backend\Block\Widget\Button',
            ['label' => __('New Block Name'), 'onclick' => 'editSet.rename()']
        );
    ...
    {
        return $this->getUrl('bluefoot/entity_contentblock/save', ['id' => $this->_getSetId()]);
    }
    ...
    protected function _toHtml()
    {
        $this->_eventManager->dispatch(
            'adminhtml_bluefoot_entity_contentblock_set_main_html_before',
            ['block' => $this]
        );
