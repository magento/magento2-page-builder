    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'title' => __('Unique Value (not shared with other content blocks)'),
                'note' => __('Does this content attribute contain a unique value, not shared with other content blocks?'),
                'values' => $yesno
            ]
        );
