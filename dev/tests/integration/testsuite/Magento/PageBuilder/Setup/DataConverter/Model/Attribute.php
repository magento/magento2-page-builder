...
use Magento\PageBuilder\Setup\DataConverter\Model\Entity\ReservedAttributeList as ReservedAttributeList;
...
class Attribute extends \Magento\Eav\Model\Attribute
{
     ...
     * @param ReservedAttributeList                                         $entityReservedAttributeList
    ...
    public function __construct(
        ...
        ReservedAttributeList $entityReservedAttributeList,
    ...
    {
        $this->_init('Magento\PageBuilder\Setup\DataConverter\Model\ResourceModel\Attribute');
    }

    /**
     * Get the data model for an entity
     *
     * @param \Magento\PageBuilder\Setup\DataConverter\Model\Entity $entity
     *
     * @return bool|mixed
     */
    public function getDataModel(\Magento\PageBuilder\Setup\DataConverter\Model\Entity $entity)
    {
