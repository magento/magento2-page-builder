...
define([
    ...
    describe('Magento_PageBuilder/js/form/provider/conditions-data-processor', function () {
        it('Should delete the normalize the data to the specified attribute', function () {
            var model = {
        ...
        it('Should delete the normalize the data to the specified deep-nested attribute', function () {
            var model = {
