    ...
    function createBlock(config, parent, stage, formData) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new Promise(function (resolve_1, reject_1) { require([getBlockComponentPath(config)], resolve_1, reject_1); })];
                    case 1:
                        c = _a.sent();
                        return [2 /*return*/, new c(parent, stage || parent.stage, config, formData || {})];
                }
            });
        });
    }
