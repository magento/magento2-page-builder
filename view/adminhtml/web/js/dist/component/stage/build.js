    ...
    var Build = (function (_super) {
        ...
        Build.prototype.parseAndBuildElement = function (element, parent) {
            ...
            if (element instanceof HTMLElement &&
                element.getAttribute(config_1.Config.getValue('dataRoleAttributeName').toString())) {
                parent = parent || this.stage;
                var role = element.getAttribute(config_1.Config.getValue('dataRoleAttributeName').toString()), data = Build.getElementData(element), children_1 = this.getElementChildren(element);
            ...
            if (element.hasChildNodes()) {
                ...
                _.forEach(element.childNodes, function (child) {
                    ...
                    if (child.tagName && child.tagName != 'SCRIPT') {
                        if (child.hasAttribute(config_1.Config.getValue('dataRoleAttributeName').toString())) {
