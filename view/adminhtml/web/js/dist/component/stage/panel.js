define(["require", "exports", "uiComponent", "underscore", "../config"], function (require, exports, uiComponent, _, config_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var PanelComponent = uiComponent.extend({
        defaults: {
            isVisible: false,
            isCollapsed: false,
            groups: [],
        ...
        search: function (self, event) {
            ...
            if (searchValue === '') {
                ...
                this.searching(true);
                this.searchResults(_.map(_.filter(config_1.Config.getInitConfig('contentBlocks'), function (contentBlock) {
        ...
        populateContentBlocks: function () {
            var self = this, groups = config_1.Config.getInitConfig('groups'), contentBlocks = config_1.Config.getInitConfig('contentBlocks');
            ...
            if (groups && contentBlocks) {
                ...
                _.each(groups, function (group, id) {
                    ...
                    self.groups.push(new Group(id, group, _.map(_.where(contentBlocks, {
                        group: id,
                        visible: true
