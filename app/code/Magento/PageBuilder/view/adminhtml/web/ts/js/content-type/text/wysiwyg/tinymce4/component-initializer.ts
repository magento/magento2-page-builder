...
export default class ComponentInitializer implements WysiwygComponentInitializerInterface {
    ...
    private onFocus() {
        ...
        if ($(window).width() < this.$element.offset().left + parseInt(this.config.additional.minToolbarWidth, 10)) {
        ...
        $.each(this.config.additional.parentSelectorsToUnderlay, (i, selector) => {
