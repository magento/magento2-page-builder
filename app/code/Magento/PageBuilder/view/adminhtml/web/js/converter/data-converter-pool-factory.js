/*eslint-disable */
define(["Magento_PageBuilder/js/loader", "Magento_PageBuilder/js/config", "Magento_PageBuilder/js/converter/data-converter-pool"], function (_loader, _config, _dataConverterPool) {
  /**
