/*eslint-disable */
define(["jquery", "knockout", "mage/translate", "Magento_PageBuilder/js/modal/dismissible-confirm", "underscore", "Magento_PageBuilder/js/binding/live-edit", "Magento_PageBuilder/js/binding/sortable", "Magento_PageBuilder/js/binding/sortable-children", "Magento_PageBuilder/js/content-type-factory", "Magento_PageBuilder/js/content-type-menu", "Magento_PageBuilder/js/content-type-menu/edit", "Magento_PageBuilder/js/content-type-menu/option", "Magento_PageBuilder/js/content-type-menu/title", "Magento_PageBuilder/js/drag-drop/container-animation", "Magento_PageBuilder/js/drag-drop/sortable", "Magento_PageBuilder/js/events", "Magento_PageBuilder/js/master-format/style-attribute-filter", "Magento_PageBuilder/js/master-format/style-attribute-mapper", "Magento_PageBuilder/js/content-type/appearance-config"], function (_jquery, _knockout, _translate, _dismissibleConfirm, _underscore, _liveEdit, _sortable, _sortableChildren, _contentTypeFactory, _contentTypeMenu, _edit, _option, _title, _containerAnimation, _sortable2, _events, _styleAttributeFilter, _styleAttributeMapper, _appearanceConfig) {
  ...
  function () {
    ...
    _proto.onOptionRemove = function onOptionRemove() {
      ...
      var removeContentType = function removeContentType() {
        var dispatchRemoveEvent = function dispatchRemoveEvent() {
          ...
          _events.trigger("contentType:removed", params);

          _events.trigger(_this3.parent.config.name + ":contentType:removed", params);
        };
    ...
    _proto.dispatchContentTypeCloneEvents = function dispatchContentTypeCloneEvents(originalContentType, duplicateContentType, index) {
      ...
      _events.trigger("contentType:duplicate", duplicateEventParams);

      _events.trigger(originalContentType.config.name + ":contentType:duplicate", duplicateEventParams);
    };
    /**
     * Bind events
     */
    ...
    _proto.updateObservables = function updateObservables() {
      ...
      _events.trigger("previewObservables:updated", {
        preview: this
      });
    };
