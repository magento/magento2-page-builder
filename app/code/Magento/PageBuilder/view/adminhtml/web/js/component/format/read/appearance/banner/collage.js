  ...
  function () {
    ...
    _proto.read = function read(element) {
      ...
      var response = {
        ...
        min_height: element.querySelector(".pagebuilder-banner-wrapper").style.minHeight ? parseInt(element.querySelector(".pagebuilder-banner-wrapper").style.minHeight, 10) : 0,
