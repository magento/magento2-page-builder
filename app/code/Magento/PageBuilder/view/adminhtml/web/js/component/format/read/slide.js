/*eslint-disable */
define(["Magento_PageBuilder/js/utils/color-converter", "Magento_PageBuilder/js/utils/extract-alpha-from-rgba", "Magento_PageBuilder/js/utils/image", "./default"], function (_colorConverter, _extractAlphaFromRgba, _image, _default) {
  /**
