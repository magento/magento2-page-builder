/*eslint-disable */
define(["Magento_PageBuilder/js/loader", "Magento_PageBuilder/config", "Magento_PageBuilder/js/property/element-converter-pool"], function (_loader, _config, _elementConverterPool) {
  /**
