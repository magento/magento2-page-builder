...
define(["knockout", "Magento_PageBuilder/js/events"], function (_knockout, _events) {
  ...
  function moveContentType(contentType, targetIndex, targetParent) {
    ...
    var sourceParent = contentType.containerContentType;
    var sourceIndex = contentType.containerContentType.children().indexOf(contentType);
    ...
    if (targetParent && sourceParent !== targetParent) {
      contentType.containerContentType = targetParent; // Handle dragging between sortable elements
