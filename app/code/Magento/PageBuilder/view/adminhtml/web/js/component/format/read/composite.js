/*eslint-disable */
define(["Magento_PageBuilder/js/loader", "underscore", "Magento_PageBuilder/js/component/block/appearance-config", "Magento_PageBuilder/js/config"], function (_loader, _underscore, _appearanceConfig, _config) {
  /**
