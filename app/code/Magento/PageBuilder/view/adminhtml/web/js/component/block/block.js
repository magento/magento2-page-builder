/*eslint-disable */
define(["underscore", "../stage/previews", "../stage/structural/abstract", "../../component/block/appearance-config"], function (_underscore, _previews, _abstract, _appearanceConfig) {
  ...
  function (_Structural) {
     ...
     * @param formData
     */
    function Block(parent, stage, config, formData, propertyPool, converterPool) {
      var _this;

      _this = _Structural.call(this, parent, stage, config, propertyPool, converterPool) || this;
      _this.title = void 0;
