/*eslint-disable */
define(["jquery", "knockout", "mage/translate", "tabs", "underscore", "Magento_PageBuilder/js/config", "Magento_PageBuilder/js/content-type-factory", "Magento_PageBuilder/js/content-type-menu/option", "Magento_PageBuilder/js/events", "Magento_PageBuilder/js/content-type/preview-collection"], function (_jquery, _knockout, _translate, _tabs, _underscore, _config, _contentTypeFactory, _option, _events, _previewCollection) {
  ...
  function (_PreviewCollection) {
    ...
    function Preview(parent, config, observableUpdater) {
      ...
      _events.on("tabs:contentType:afterRender", function (args) {
        if (args.id === _this.parent.id && _this.element) {
          _this.buildTabs();
        }
      });

      _events.on("tab-item:contentType:mount", function (args) {
      ...
      _events.on("tab-item:contentType:removed", function (args) {
      ...
      (0, _contentTypeFactory)(_config.getContentTypeConfig("tab-item"), this.parent, this.parent.stageId).then(function (tab) {
        _events.on("tab-item:contentType:mount", function (args) {
          if (args.id === tab.id) {
            ...
            _events.off("tab-item:contentType:mount:" + tab.id);
          }
    ...
    _proto.bindEvents = function bindEvents() {
      ...
      _events.on("tabs:contentType:dropped:create", function (args) {
      ...
      _events.on("tab-item:contentType:duplicate", function (args) {
