/*eslint-disable */
define(["underscore", "Magento_PageBuilder/js/master-format/attribute-mapper", "Magento_PageBuilder/js/master-format/style-attribute-mapper"], function (_underscore, _attributeMapper, _styleAttributeMapper) {
  /**
