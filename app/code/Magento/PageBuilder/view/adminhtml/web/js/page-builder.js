/*eslint-disable */
define(["knockout", "mageUtils", "underscore", "Magento_PageBuilder/js/config", "Magento_PageBuilder/js/events", "Magento_PageBuilder/js/panel", "Magento_PageBuilder/js/stage"], function (_knockout, _mageUtils, _underscore, _config, _events, _panel, _stage) {
  /**
  ...
  function () {
    ...
    _proto.initListeners = function initListeners() {
      ...
      _events.on("pagebuilder:toggleFullScreen:" + this.id, function () {
    ...
    _proto.onFullScreenChange = function onFullScreenChange() {
      ...
      _events.trigger("pagebuilder:fullScreen:" + this.id, {
