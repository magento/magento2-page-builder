/*eslint-disable */
define(["Magento_PageBuilder/js/loader", "Magento_PageBuilder/js/config", "Magento_PageBuilder/js/component/block/property-reader-pool"], function (_loader, _config, _propertyReaderPool) {
  /**
