/*eslint-disable */
define(["jquery", "knockout", "Magento_PageBuilder/js/events", "underscore", "Magento_PageBuilder/js/config", "Magento_PageBuilder/js/drag-drop/container-animation", "Magento_PageBuilder/js/drag-drop/move-content-type", "Magento_PageBuilder/js/drag-drop/registry", "Magento_PageBuilder/js/utils/create-stylesheet", "Magento_PageBuilder/js/content-type/preview-collection", "Magento_PageBuilder/js/content-type/column-group/drag-and-drop", "Magento_PageBuilder/js/content-type/column-group/factory", "Magento_PageBuilder/js/content-type/column-group/registry", "Magento_PageBuilder/js/content-type/column-group/resizing"], function (_jquery, _knockout, _events, _underscore, _config, _containerAnimation, _moveContentType, _registry, _createStylesheet, _previewCollection, _dragAndDrop, _factory, _registry2, _resizing) {
  ...
  function (_PreviewCollection) {
    ...
    function Preview(parent, config, stageId) {
      ...
      _events.on("column:bindResizeHandle", function (args) {
      ...
      _events.on("column:initElement", function (args) {
        // Does the events parent match the previews parent? (e.g. column group)
        if (args.parent.id === _this.parent.id) {
    ...
    _proto.bindDraggable = function bindDraggable(column) {
      ...
      column.element.draggable({
        ...
        start: function start(event) {
          ...
          _events.trigger("column:drag:start", {
        ...
        stop: function stop() {
          ...
          _events.trigger("column:drag:stop", {
